...
import { fadeIn, textVariant } from '../utils/motins'
    ...
    <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className='relative w-full h-[230px]'>
          <img src={image} alt={name} className='w-full h-full object-contain rounded-3xl' />

          {/* Links */}
          <div
            className='absolute inset-0 flex justify-end m-1 gap-1 card-img_hover'>
